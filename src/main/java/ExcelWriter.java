...
public class ExcelWriter {
    ...
    static final Receipt sample = new Receipt(
            ...
            "○○○○○○○○○○○○○○○○○○○○\n○○○○○○○○○○○○○○○○○○○○",
            "株式会社ビームスホールディングス○○○○\n○○○○○○○○○○○○○○○○○○○○",
            "三井ショッピングパークオンラインECショップ",
            "三井ショッピングパークカスタマーセンター",
            "TEL：03-1111-2222");

    public static final void main(String argv[]) throws IOException, InvalidFormatException {
        modify(new File(RECEIPT_TEMPLATE_XLSX_FILE_PATH), new File(RECEIPT_OUTPUT_XLSX_FILE_PATH), sample);
    }

    // Example to modify an existing excel file
    private static void modify(File template, File output, Object bean) throws InvalidFormatException, IOException {

        Path outputPath = java.nio.file.Files.copy(FileSystems.getDefault().getPath(template.getPath()), FileSystems.getDefault().getPath(output.getPath()));
...
//        FileOutputStream fileOut = new FileOutputStream(new File("./output2.xlsx"));
